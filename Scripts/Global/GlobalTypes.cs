...
{
    public enum ColorSet { red, blue, white, brown, green, yellow }; // Global color set
    ...
    public enum ScreenTransition { restart, hubEntry, levelEntry, hubEntryCompleted, worldEntry, optionsEntry, menuEntry, gameEntry };
}
